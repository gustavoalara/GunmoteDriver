#if !defined(_gunmotep1_COMMON_H_)
#define _gunmotep1_COMMON_H_

//
//These are the device attributes returned by gunmotep1 in response
// to IOCTL_HID_GET_DEVICE_ATTRIBUTES.
//

#define gunmotep1_PID              0xBA1C
#define gunmotep1_VID              0x001F
#define gunmotep1_VERSION          0x0001
...
#pragma pack(1)
typedef struct _gunmotep1_CONTROL_REPORT_HEADER
{
...
#pragma pack(1)
typedef struct _gunmotep1_KEYBOARD_REPORT
{
...
} gunmotep1KeyboardReport;

typedef struct _gunmotep1_KEYBOARD_OUTPUT_REPORT
{
    // Num Lock, Caps Lock, Scroll Lock, Compose, Kana
    BYTE      LedFlags;
} gunmotep1KeyboardOutputReport;
...
#pragma pack(1)
typedef struct _gunmotep1_MOUSE_REPORT
{
...
#pragma pack(1)
typedef struct _gunmotep1_FEATURE_REPORT
{
...
} gunmotep1FeatureReport;

typedef struct _gunmotep1_MAXCOUNT_REPORT
{
...
#pragma pack(1)
typedef struct _gunmotep1_MESSAGE_REPORT
{
